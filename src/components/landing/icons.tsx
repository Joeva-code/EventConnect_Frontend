...
export function StarOutline({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 3l2.6 5.27 5.82.85-4.21 4.1.99 5.79L12 16.27l-5.2 2.74.99-5.79-4.21-4.1 5.82-.85L12 3z" />
    </svg>
  );
}
...
export function Wallet({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M3 7v10a2 2 0 002 2h14a1 1 0 001-1v-8a1 1 0 00-1-1H6a2 2 0 01-2-2z" />
      <path d="M16 14h.01" />
    </svg>
  );
}
...
export function Sparkle({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M19 15l.6 1.8L21.4 17.4l-1.8.6L19 19.8l-.6-1.8-1.8-.6 1.8-.6L19 15z" />
    </svg>
  );
}
...
export function BadgeCheck({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2l2.4 1.4 2.8-.2 1.2 2.5 2.5 1.2-.2 2.8L22 12l-1.4 2.4.2 2.8-2.5 1.2-1.2 2.5-2.8-.2L12 22l-2.4-1.4-2.8.2-1.2-2.5-2.5-1.2.2-2.8L2 12l1.4-2.4-.2-2.8 2.5-1.2 1.2-2.5 2.8.2L12 2z" />
