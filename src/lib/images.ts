...
export const EVENT_TYPE_IMAGE_POOL: Record<string, string[]> = {
  Wedding: [
    "https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1527529482837-469817a48964?auto=format&fit=crop&w=800&q=80",
  ...
  "Naming Ceremony": [
    "https://images.unsplash.com/photo-1519689680058-324335eb6361?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1505236858219-8359eb29e329?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&w=800&q=80",
  ],
  Conference: [
  ...
  "Book Launch": [
    "https://images.unsplash.com/photo-1524995997946-a1c2e315a2f8?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1516035069371-29a1b244cc9b?auto=format&fit=crop&w=800&q=80",
  ],
  Graduation: [
    "https://images.unsplash.com/photo-1523050854058-8df90110a5f1?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1554048612-b6a482bc67e5?auto=format&fit=crop&w=800&q=80",
  ],
  "Corporate Event": [
...
export function getEventTypeImage(type: string, index: number): string {
  ...
  const pool = EVENT_TYPE_IMAGE_POOL[normalized] || FALLBACK_IMAGES;
